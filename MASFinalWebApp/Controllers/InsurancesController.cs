...
namespace MASFinalWebApp.Controllers
{
    public class InsurancesController : Controller
    {
        ...
        public InsurancesController(InsurexDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var insurance = await _context.Insurances
                ...
                .ThenInclude(s=> s.InsurancePackage)
        ...
        public async Task<IActionResult> Create([Bind("InsuranceID,InsuranceAmount,InsuranceRange,GeneralTermsAndConditions")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InsuranceID,InsuranceAmount,InsuranceRange,GeneralTermsAndConditions")] Insurance insurance)
        {
